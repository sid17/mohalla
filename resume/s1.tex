...
\item
	\headerrow
		{\textbf{Co-founder at Fundebaazi.in}}
		{\emph{January 2014-Present}}
	
	
	\begin{itemize*}
	\setlength{\itemsep}{3pt}
		\item Founded a web based solution to enable people to access career advice easily and efficiently from au-
thentic advisors
		\item Developed an online client to establish secure and anonymous conversations between advisors and people
	...
	\headerrow
		...
		{\emph{Android Application | December 2014}}
...
\item
	\headerrow
		...
		{\emph{Web Application | May 2014-June 2014}}
